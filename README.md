...
- **[resume-work](./skills/engineering/resume-work/SKILL.md)** — Resume work paused by an interruption (end of day, blackout, dropped connection): study a brief, audit worktrees and uncommitted changes for half-finished work, then write a continuation plan ending in a ready-to-run agentic prompt.
