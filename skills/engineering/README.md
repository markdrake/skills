...
- **[resume-work](./resume-work/SKILL.md)** — Resume work paused by an interruption: study a brief, audit worktrees and uncommitted changes for half-finished work, then write a continuation plan ending in a ready-to-run agentic prompt.
